...
\title{Improving reproducibility of scientific software using Nix/NixOS}

\author{\IEEEauthorblockN{Max Hausch}
\IEEEauthorblockA{Stuttgart, Germany \\
st175425@stud.uni-stuttgart.de}
\and
\IEEEauthorblockN{Simon Hauser}
\IEEEauthorblockA{Stuttgart, Germany \\
...
Traditional approaches to reproducibility, such as manual setup instructions or virtualization techniques, are time-consuming, prone to errors, and not scalable.
...
This paper explores the use of Nix/NixOS to improve the reproducibility of scientific software, focusing on a case study of preCICE\cite{preCICEv2} and its adapters and solvers.
