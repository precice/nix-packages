...
In order for DUNE to work properly, the two environment variables must be set at runtime.
This can be achieved by souring the \texttt{set-dune-vars} script, which we provide, after that DUNE can be used as expected.
