...
There are a wide range of phases that always get executed in the same order and package maintainers can then decide weather the default phase is sufficient or needs to be overriden in order to produce a working build.
...
It is also worth mentioning that most phases have a pre and post step, which users can use to do slight adjustments when they need to override excisting packages.
