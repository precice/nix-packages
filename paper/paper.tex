...
The nutils~\cite{nutils} project can be build using \texttt{buildPythonPackage}, one test needs to be disabled, the rest of the testsuite passed without any issues.
While the preCICE distribution ships with nutils v7.0, one tutorial case requires v6.3 because of the usage of a deprecated function.
